...
class PlantMonitorApp(ctk.CTk):
    ...
    def fetch_data(self):
        try:
            ...
            # Example: <div class='dado'>️ Temperatura: <strong>25.0 °C</strong></div>
            ...
            if temp_match and light_match:
                temp_val = temp_match.group(1)
                light_val = light_match.group(1)
                return {"temp": temp_val, "light": light_val, "status": "Conectado"}
            else:
